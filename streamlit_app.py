# ==============================================================================
# CÓDIGO DEL SIMULADOR v19 (VERSIÓN CON CONTRASTE HTML CORREGIDO)
# ==============================================================================
...
# Fecha de corrección de contraste HTML: 2025-07-10
# ==============================================================================
...
# --- NOTA DE DISEÑO: PALETA DE COLORES CORREGIDA PARA ALTO CONTRASTE ---
# En respuesta a la retroalimentación, se ha ajustado la paleta para garantizar que todo el texto
# sea legible, cumpliendo con los estándares de accesibilidad (WCAG AA).
# Se han seleccionado colores más oscuros para texto y fondos de botones para asegurar
# un contraste adecuado contra fondos claros y viceversa.
PALETA_COLORES = {
    'fondo_app': '#F0F2F6',
    'fondo_contenedor': '#FFFFFF',
    'borde': '#DEE2E6',
    'primario': '#005F73',      # Azul oscuro/petróleo (Buen contraste con texto blanco)
    'secundario': '#00796B',    # Teal oscuro (Alto contraste para títulos sobre blanco)
    'acento': '#D97706',        # Ámbar oscuro (Alto contraste para acentos)
    'texto_principal': '#212529', # Casi negro, para máxima legibilidad
    'texto_secundario': '#495057',# Gris oscuro, para textos de apoyo
    'texto_claro': '#FFFFFF',   # Blanco puro, para usar sobre fondos oscuros
    'grafico_general': '#A7C7E7', # Azul pastel (Color claro para gráficos, usa texto oscuro)
    'grafico_reserva': '#005F73', # Coincide con el primario (Color oscuro, usa texto claro)
    'exito': '#1E8449',         # Verde oscuro (Buen contraste con texto blanco en botones)
    'error': '#C0392B',         # Rojo oscuro (Buen contraste con texto blanco)
    'advertencia': '#F39C12',   # Amarillo/Naranja (Para usar con texto oscuro)
}
...
class GeneradorReporte:
    ...
    def generar_mensajes_html(self) -> str:
        ...
        # CORRECCIÓN: Usar 'texto_principal' para máximo contraste.
        return f"<ul style='padding-left:20px;font-size:0.95em;line-height:1.6;color:{PALETA_COLORES['texto_principal']};'>{contenido}</ul>"
    ...
    def _generar_conclusion_base(self) -> str:
        ...
        return (
            ...
            # CORRECCIÓN: Usar 'texto_principal' para máximo contraste.
            f"<ul style='padding-left:20px;font-size:0.9em; line-height:1.6;color:{PALETA_COLORES['texto_principal']};'>"
    ...
    def get_reporte_html(self) -> str:
        ...
        <style>
            ...
            .report-card {{
                /* CORRECCIÓN: Se elimina el fondo específico para heredar el blanco puro del contenedor. */
...
def main():
    ...
    # --- PIE DE PÁGINA ---
    st.divider()
    with st.expander("⚖️ Marco Normativo"):
        st.markdown("""
    ...
    with st.expander("🧑‍💻 Acerca de este Simulador y Créditos"):
